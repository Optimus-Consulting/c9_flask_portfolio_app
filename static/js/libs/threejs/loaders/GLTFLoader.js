...
var GLTFLoader = ( function () {
	...
	GLTFParser.prototype.loadAccessor = function ( accessorIndex ) {
		...
		return Promise.all( pendingBufferViews ).then( function ( bufferViews ) {
			...
			if ( byteStride && byteStride !== itemBytes ) {
				...
				var ibCacheKey = 'THREE.InterleavedBuffer:' + accessorDef.bufferView + ':' + accessorDef.componentType + ':' + ibSlice + ':' + accessorDef.count;
	...
	GLTFParser.prototype.assignFinalMaterial = function ( mesh ) {
		...
		if ( mesh.isPoints ) {
			...
			var cacheKey = 'THREE.PointsMaterial:' + material.uuid;
			...
			var cacheKey = 'THREE.LineBasicMaterial:' + material.uuid;
